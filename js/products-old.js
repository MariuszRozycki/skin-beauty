...
let treatmentName;
let flag = true;
let open = `<i class="fas fa-chevron-circle-down"></i>`;
let close = `<i class="fas fa-chevron-circle-up"></i>`;
let showMore = open;
    ...
    treatments: [
      {
        dataId: ++dataId,
        treatment: `
      <li class="treatment-name" data-id=${dataId}>Vippe extensions ${showMore}</li>
